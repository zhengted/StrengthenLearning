...
def prepare_truncated_policy_iteration(cfg_path: str = "config.json") -> Tuple:
    ...
    tpi_extra = cfg.algorithms.truncated_policy_iteration
    ...
    return P, R, state_idx, action_idx, terminal_states, shared, tpi_extra, cfg
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for eval_iter in range(tpi_extra.truncation_k):
            delta = 0
    ...
    print(f"\nTruncated Policy Iteration took {elapsed_time:.4f} seconds to run.")
